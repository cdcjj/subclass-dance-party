describe('fightingDancer', function() {
  ...
  it('should have a step function that makes its node fight', function() {
    sinon.spy(fightingDancer.$node, 'toggleClass');
    fightingDancer.step();
    expect(fightingDancer.$node.toggleClass.called).to.be.true;
  });
